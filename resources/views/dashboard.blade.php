                ...
                <div class="col-md-6 col-lg-4">
                    <div class="box mb-4 mb-lg-0">
                        ...
                        <div class="box-content">
                            ...
                            <a href="{{ route('iron-deficiency-anaemia') }}" class="btn btn-primary">Read more</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="box mb-4 mb-lg-0">
                        ...
                        <div class="box-content">
                            ...
                            <a href="{{ route('disease-management-through-diet') }}" class="btn btn-primary">Read more</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="box">
                        ...
                        <div class="box-content">
                            ...
                            <a href="{{ route('yoga-poses-managing-anaemia') }}" class="btn btn-primary">Read more</a>
                        </div>
                    </div>
                </div>
            </div>
