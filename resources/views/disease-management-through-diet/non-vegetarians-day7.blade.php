                            ...
                            <div class="card bg-green box-shadow2">
                                <div class="card-body">
                                    <div class="diet-chart-container">
                                        ...
                                        <div class="diet-chart-item">
                                            <h5>Breakfast :</h5>
                                            <p>Vegetable Daliya-1 Bowl /Dal Paratha-2</p>
                                        </div>
                                        <div class="diet-chart-item">
                                            <h5>Mid Morning :</h5>
                                            <p>Pomegranate / Guava/Orange - 1 eachl</p>
                                        </div>
                                        <div class="diet-chart-item">
                                            <h5>Lunch :</h5>
                                            <ul class="list-unstyled list-unordered">
                                                <li>Red lentil - ½ bowl</li>
                                                <li>Soybean curry - ½ bowl</li>
                                        ...
                                        <div class="diet-chart-item">
                                            <h5>Dinner :</h5>
                                            <ul class="list-unstyled list-unordered">
                                                <li>Chicken Biryani- 1 Plate</li>
                                                <li>Tomato ,onion, cucumber salad-1 Bowl</li>
