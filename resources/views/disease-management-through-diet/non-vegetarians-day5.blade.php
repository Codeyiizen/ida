                                ...
                                <div class="card-body">
                                    <div class="diet-chart-container">
                                        ...
                                        <div class="diet-chart-item">
                                            ...
                                            <ul class="list-unstyled list-unordered">
                                                <li>@lang('disease-management-through-diet.5mid-morning_1')</li>
                                                <li>@lang('disease-management-through-diet.5mid-morning_2')</li>
                                            </ul>
                                        </div>
                                        <div class="diet-chart-item">
                                            ...
                                            <ul class="list-unstyled list-unordered">
                                                ...
                                                <li>@lang('disease-management-through-diet.5lunch_2')</li>
                                                <li> @lang('disease-management-through-diet.5lunch_3')</li>
                                                <li>@lang('disease-management-through-diet.5lunch_4')</li>
                                        ...
                                        <div class="diet-chart-item">
                                            ...
                                            <ul class="list-unstyled list-unordered">
                                                ...
                                                <li>@lang('disease-management-through-diet.5Snacks_2')</li>
                                            </ul>
                                        </div>
                                        <div class="diet-chart-item">
