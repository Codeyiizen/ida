                                ...
                                <div class="card-body">
                                    <div class="diet-chart-container">
                                        ...
                                        <div class="diet-chart-item">
                                            ...
                                            <ul class="list-unstyled list-unordered">
                                                <li>@lang('disease-management-through-diet.omlette')</li>
                                                <li>@lang('disease-management-through-diet.fruit')</li>
                                            </ul>
                                        </div>
                                        <div class="diet-chart-item">
                                            <h5>@lang('disease-management-through-diet.mid')</h5>
                                            <p>@lang('disease-management-through-diet.chat')</p>
                                        </div>
                                        <div class="diet-chart-item">
                                        ...
                                        <div class="diet-chart-item">
                                            ...
                                            <ul class="list-unstyled list-unordered">
                                                <li>@lang('disease-management-through-diet.Fish')</sli>
                                                <li>@lang('disease-management-through-diet.Roti2')</li>
