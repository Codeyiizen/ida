            ...
            <div class="row text-center">
                <div class="col-md-3">
                    <div class="card box-shadow hover-styled style-1">
                        ...
                        <div class="card-body d-flex flex-column">
                            <h4>Locally available iron and vitamin C rich food</h4>
                            ...
                            <div class="btn-container mt-auto mb-0">
                                <a href="disease-management-through-diet/locally-available-iron-vitamin-rich-food.html"
                ...
                <div class="col-md-3">
                    <div class="card box-shadow hover-styled style-1">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="btn-container mt-auto mb-0">
                                <a href="disease-management-through-diet/diet-tips.html" class="btn btn-primary">Learn
                                    More</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-3">
                    <div class="card box-shadow hover-styled style-1">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="btn-container mt-auto mb-0">
                                <a href="disease-management-through-diet/drugs-instruction.html"
                ...
                <div class="col-md-3">
                    <div class="card box-shadow hover-styled style-1">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="btn-container mt-auto mb-0">
                                <a href="disease-management-through-diet/foods-avoid.html" class="btn btn-primary">Learn
                                    More</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-3">
                    <div class="card box-shadow hover-styled style-1">
                        ...
                        <div class="card-body d-flex flex-column">
                            <h4>Diet Plan for Anaemia Patient</h4>
                            ...
                            <div class="btn-container mt-auto mb-0">
                                <a href="disease-management-through-diet/diet-plan-anaemia-patient.html"
                                    class="btn btn-primary">Learn More</a>
                            </div>
                        </div>
                    </div>
